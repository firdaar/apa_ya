...
def test_normal():
  ...
  for newData in range(0,countData):
    ...
    assert Data[newData].get('file_name') != None
    assert Data[newData].get('file_size') != None
    assert Data[newData].get('amt_record') != None
    assert Data[newData].get('path') != None
    assert Data[newData].get('entry_type') != None
    assert Data[newData].get('action') != None
    assert Data[newData].get('status') != None
    assert Data[newData].get('creaated_at') != None
